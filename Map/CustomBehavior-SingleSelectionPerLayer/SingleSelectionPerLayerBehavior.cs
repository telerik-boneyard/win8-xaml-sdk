...
namespace CustomBehavior_SingleSelectionPerLayer
{
    /// <summary>
    /// Implements custom single selection mode per layer.
    /// </summary>
    public class SingleSelectionPerLayerBehavior : MapShapeSelectionBehavior
    {
        private Dictionary<MapLayer, IMapShape> selectedShapesPerLayer;
        private IList<object> shapesToRemove;

        /// <summary>
        /// Initializes a new instance of the <see cref="SingleSelectionPerLayerBehavior" /> class.
        /// </summary>
        public SingleSelectionPerLayerBehavior()
        {
